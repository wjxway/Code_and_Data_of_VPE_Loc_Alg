...
void motor_move(point pos)
{
	...
	unsigned short int maxerror=2500,acttheshold=40;
...
////o
//point p1={0.491756, -2.70459}, p2={1.3435, -1.9799}, p3={1.83526, -0.724693}, p4={1.83526, 0.724693}, p5={1.3435, 1.9799}, p6={0.491756, 2.70459}, p7={-0.491756, 2.70459}, p8={-1.3435, 1.9799}, p9={-1.83526, 0.724693}, p10={-1.83526, -0.724693}, p11={-1.3435, -1.9799}, p12={-0.491756, -2.70459}, p13={0.382683, -1.84776}, p14={0.92388, -0.765367}, p15={0.92388, 0.765367}, p16={0.382683, 1.84776}, p17={-0.382683, 1.84776}, p18={-0.92388, 0.765367}, p19={-0.92388, -0.765367}, p20={-0.382683, -1.84776};
//line l[20];
//l[0]=(line){p1, p2}; l[1]=(line){p2, p3}; l[2]=(line){p3, p4}; l[3]=(line){p4, p5}; l[4]=(line){p5, p6}; l[5]=(line){p6, p7}; l[6]=(line){p7, p8}; l[7]=(line){p8, p9}; l[8]=(line){p9, p10}; l[9]=(line){p10, p11}; l[10]=(line){p11, p12}; l[11]=(line){p12, p1}; l[13]=(line){p13, p14}; l[14]=(line){p14, p15}; l[15]=(line){p15, p16}; l[16]=(line){p16, p17}; l[17]=(line){p17, p18}; l[18]=(line){p18, p19}; l[19]=(line){p19, p20}; l[20]=(line){p20, p13}; 
//l[12]=(line){p13, p14}; l[13]=(line){p14, p15}; l[14]=(line){p15, p16}; l[15]=(line){p16, p17}; l[16]=(line){p17, p18}; l[17]=(line){p18, p19}; l[18]=(line){p19, p20}; l[19]=(line){p20, p13};
//int length=20;


	//rectangle-disk
	point p1={-2., -2.}, p5={-2., 2.},p9={2., 2.}, p13={2., -2.}, p17={0.8, 0.}, p18={0.4, 0.6928}, p19={-0.4, 0.6928}, p20={-0.8, 0.}, p21={-0.4001, -0.6929}, p22={0.3999, -0.6929};
	line l[9];
	l[0]=(line){p1, p13};l[1]=(line){p13, p9}; l[2]=(line){p9, p5}; l[3]=(line){p5, p1}; l[4]=(line){p21, p22}; l[5]=(line){p22, p17}; l[6]=(line){p17, p18}; l[7]=(line){p18, p19}; l[8]=(line){p19, p20}; l[9]=(line){p20, p21};
	int length=9;
